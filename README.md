...
- Stable follow-output behavior, IME-aware voice composer, and live native Markdown/LaTeX rendering
...
The generated artifact is `artifacts/LiteChat-0.7.5-debug.apk`. Android may ask you to allow installation from the app used to open the file. Debug builds are signed with the standard local Android debug certificate and are intended for testing, not store distribution.
